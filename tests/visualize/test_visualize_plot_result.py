...
def test_correlation_matrix(tmp_path):
    ...
    fig = plot_result.correlation_matrix(corr_mat, labels, fname)
    assert (
        compare_images(
...
def test_pulls(tmp_path):
    ...
    fig = plot_result.pulls(bestfit, uncertainty, labels, fname)
...
def test_scan(tmp_path):
    ...
    fig = plot_result.scan(par_name, par_mle, par_unc, par_vals, par_nlls, fname)
...
def test_limit(tmp_path):
    ...
    fig = plot_result.limit(observed_CLs, expected_CLs, poi_values, fname)
